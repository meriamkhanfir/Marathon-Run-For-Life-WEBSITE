...
<body>
  ...
  <div class="container4">
    ...
    <h2>Inscription parcour <br> 42 Km</h2>
    <form class="formdon2" action="formulaire inscription42.php" method="Post">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO inscription42 (Nom,Prenom ,Age,Telephone,Email,Pays,Ville,Message) VALUES ('$nom', '$prenom',  '$age','$telephone','$email','$pays','$ville','$message')";
